...
HIGHLIGHT_SLOTS  = [
    "hero", "about", "contact", "login",
    "portrait-session", "standard-session", "reservation-hero",
    "cover-maternity", "cover-newborn", "cover-family-portraits", "cover-brands-and-events",
]
